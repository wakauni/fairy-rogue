...
const CLICK_EVENT_DIALOGUE = {
    ...
    count_10: {
        text: [
            "んっ？ ……今、空気がビリビリ震えたような……気のせいでしょうか？",
            "ひゃうっ！ ……なんだか、背筋がゾクゾクしました。風邪かな……？"
        ],
        action: "shake"
    },
    // 20回目: 発熱
    count_20: {
        text: [
            "はぁ……っ。急に、体が熱くなって……。魔力の流れが、乱れてる……？",
            "くぅっ……お腹の奥が、熱い……。何かが溜まっていくみたいで……怖いです。"
        ],
        action: "shake_strong"
    },
    ...
    count_30: {
        text: [
            "きゃあああっ！？ ふ、服が……弾け飛んじゃいました……ッ！ ま、魔力が溢れて……っ！"
        ],
        event: "strip"
    },
    // 40回目: 恥じらい
    count_40: {
        text: [
            "うぅ……裸ん坊になっちゃった……。空気が肌に刺さるみたいに敏感で……じっとしてられません……。",
            "ダメ、見ないで……。肌が赤くなってる……。熱くて、ヒリヒリして……変な感じです……。"
        ],
        action: "shake"
    },
    // 50回目: 膨張の予兆
    count_50: {
        text: [
            "んぐっ……！ まだ、まだ魔力が流れ込んでくる……！ 体が……きしんでる……！？",
            "はぁ、はぁ……っ！ 許容量オーバーです……ッ！ 中から突き上げられて……膨らいじゃう……ッ！"
        ],
        action: "shake_strong"
    },

    // ----------------------------------------------------------------
    // ■ 変身2: 膨張Lv1 (Growth Lv1)
    // ----------------------------------------------------------------
    // 60回目: 【イベント】発育開始
    count_60: {
        text: [
            "あ……っ！？ 胸が……お尻が……熱を持って、膨らんで……！ うそ、大きくなってる……！？"
        ],
        event: "expand_1"
    },
    // 70回目: 張り
    count_70: {
        text: [
            "皮膚が……パツパツに張って……痛い、でも……気持ちいい……。私、どうなっちゃうの……？",
            "んっ……。膨らんだところが、熱い……。魔力が詰まって、硬くなってる……。"
        ],
        action: "shake"
    },
    // 80回目: 止まらない成長
    count_80: {
        text: [
            "まだ……止まらない……！ もっと、もっと大きくなるって……体が疼いてる……！",
            "ふぅ……んっ……！ 膨張感が……快感に変わって……頭が、クラクラする……！"
        ],
        action: "shake_strong"
    },

    // ----------------------------------------------------------------
    // ■ 変身3: 膨張Lv2 (Growth Lv2)
    // ----------------------------------------------------------------
    // 90回目: 【イベント】重量化
    count_90: {
        text: [
            "あぁぁ……ッ！ 重い、ドンッて……！ 急に、こんなに大きく……！ 立ってられないよぉ……！"
        ],
        event: "expand_2"
    },
    // 100回目: 翻弄
    count_100: {
        text: [
            "たぷん、たぷんって……揺れるたびに、中身が暴れて……んぁっ♡ ……変な声、出ちゃう……。",
            "もう、支えきれません……。魔力の重さで……私、潰されちゃいそう……あはっ……。"
        ],
        action: "shake"
    },
    // 110回目: 思考麻痺
    count_110: {
        text: [
            "熱い……熱いよぉ……。魔力が、指先までパンパンで……触れたら、弾けちゃいそう……。",
            "もう……どうにでもして……。膨らむのが……気持ちよすぎて……おかしくなるぅ……っ！"
        ],
        action: "shake_strong"
    },

    // ----------------------------------------------------------------
    // ■ 変身4: 膨張Lv3 (Growth Lv3)
    // ----------------------------------------------------------------
    // 120回目: 【イベント】球体化
    count_120: {
        text: [
            "ひグッ！？ ……まんまる……。私、ボールみたいに……。視界が全部、お肉で埋まっちゃう……！"
        ],
        event: "expand_3"
    },
    // 130回目: 溶解
    count_130: {
        text: [
            "はぁ……あぁ……。自分の胸に埋もれて……息ができない……。甘い匂いで、脳みそが溶ける……。",
            "ズンッ、ズンッて……子宮に響くの……。もっと……もっと膨らませて……魔力、注ぎ込んでぇ……♡"
        ],
        action: "shake"
    },
    // 140回目: 限界寸前
    count_140: {
        text: [
            "あヒッ、イッ、イくっ……！ 皮が裂けちゃう……！ 限界、もう限界だよぉ……ッ！",
            "ダメ、もう入らない……ッ！ これ以上膨らんだら……私、弾けて死んじゃう……あぁッ、でもイイッ♡"
        ],
        action: "shake_strong"
    },

    // ----------------------------------------------------------------
    // ■ 変身5: 膨張Lv4 (Limit Break) & Loop
    // ----------------------------------------------------------------
    // 150回目: 【イベント】限界突破
    count_150: {
        text: [
            "あﾞあﾞあﾞぁぁぁーーッ♡♡♡ ……壊れ、ちゃった……。私、こんなに……おっきく……あはぁ……♡"
        ],
        event: "expand_4" 
    },

    // 打ち止め用ループ (150回以降、10回ごとに再生)
    limit_loop: [
...
// 連打リセット時のセリフ (各Lv3パターン)
const RESET_DIALOGUE = {
    // Lv0 (通常・焦り状態でストップ)
    // まだ始まっていないが、変なスイッチが入ってしまった余韻
    lv0: [
