...
{ 
        ...
        name: '正攻法', 
        cost: 2, 
        type: 'attack_growth', // 既存ロジックに引っかからないよう独自のタイプ名にしておくか、attackのままID分岐させる
        power: 1.2, 
        desc: 'INT×1.2 (使用するたびに威力が+0.5ずつ永続上昇)' 
    },
    // ■ 通常ビルド向け：防御無視フィニッシャー
    { 
        id: 'purity_ray', 
    ...
    { 
        ...
        type: 'attack_special', 
        power: 0.3, 
        desc: 'INT×0.3の10回攻撃。縮小時は防御無視。次回避+100%' 
    },
    // ■ マジックダーツ：最低3回保証＋80%継続のギャンブル攻撃
    { 
        id: 'magic_darts', 
        name: 'マジックダーツ', 
        cost: 2, 
        type: 'attack_multi', // 独自タイプ
        power: 0.5, 
        desc: 'INT×0.5の3回攻撃。以降、失敗するまで80%で追撃。' 
    },

    // ■ アダプト・エーテル：状態に応じて永続強化
    { 
        id: 'adapt_ether', 
        name: 'アダプト・エーテル', 
        cost: 1, 
        type: 'buff_perm', // 独自タイプ
        power: 0, // ダメージではないので0
        desc: '探索中、現在の状態に応じて永続的にステータスを強化する。' 
    },
...
// ==========================================
// ▼ 追加データ: 興奮状態突入時フレーバー (解放状態 Ver.)
// ==========================================
const FLAVOR_EVENT_DATA_EXCITED_LIBERATION = {
    // 興奮状態かつ解放状態（裸・合意）でダンジョンに突入
    // text: 状況描写（客観） / dialogue: 妖精のセリフ（能動的な誘惑・喘ぎ）
    excited_entry: {
        ...
        lv0: [
            {
                "text": "限界まで膨張した肉体を誇示するように、胸を反らせて堂々と歩く。",
                "dialogue": "見て、見てぇ……♡ 私のこの姿……。服なんて着てたら、この素晴らしいお肉が見えないでしょ……？"
            },
            {
                "text": "溢れ出る愛液と魔力が混ざり合い、歩いた跡に濡れた道ができている。",
                "dialogue": "ふふ……マーキング完了……♡ 欲しがりな魔物さんたち……私の匂い、辿ってきてね……？"
            },
            {
                "text": "通路の壁にわざと敏感な乳房を擦り付け、その刺激を楽しんでいる。",
                "dialogue": "んぁっ♡ ……ザラザラして気持ちいい……。ダンジョンの壁さん……もっと私の皮膚、いじめて……♡"
            },
            {
                "text": "重たい胸を手で持ち上げ、誰に見せるともなく先端を強調して見せる。",
                "dialogue": "ほら、パンパンだよぉ……。突っついたら、中身が飛び散っちゃうかも……。ねえ、試してみる……？"
            },
            {
                "text": "前方から風が吹くと、目を細めて全身でその愛撫を受け入れる。",
                "dialogue": "んぅ……風が、全身を舐めてるみたい……。もっと強く吹いて……私を吹き飛ばすくらいに……ッ！"
            },
            {
                "text": "理性のタガが外れ、自分を「獲物」ではなく「ご褒美」だと認識している。",
                "dialogue": "さあ、早い者勝ちですよぉ……♡ この熟しきった妖精の体……誰が最初に味見してくれるのかなぁ……？"
            },
            {
                "text": "張り詰めた皮膚が限界を訴えているが、彼女にとってはそれすら快感のスパイスだ。",
                "dialogue": "ピリピリする……裂けそう……あはっ♡ 壊れちゃう寸前が、一番生きてるって感じがするの……！"
            },
            {
                "text": "自身の重みでよろめくが、その動きすら艶めかしく、誘うようなダンスに見える。",
                "dialogue": "ゆらゆら……♡ 重たいお肉が踊ってる……。ねえ、私のこのダンス……エッチに見えますか……？"
            },
            {
                "text": "ダンジョンの奥深くに向かって、愛おしい恋人を呼ぶように声を上げる。",
                "dialogue": "奥に行けば……もっと激しい罠があるのかな？ 期待してますよ……私を、泣かせてくださいね……♡"
            },
            {
                "text": "冷たい床に大の字に寝転がり、火照った体を冷やしつつ、無防備な姿を晒す。",
                "dialogue": "あはぁ……床オナ気分……♡ 誰か通りかからないかなぁ……。踏んづけてくれても、いいんですよ？"
            },
            {
                "text": "巨大な胸に顔を埋め、自分のフェロモンを深く吸い込んで陶酔している。",
                "dialogue": "スーッ、ハァ……♡ 甘い、すごい匂い……。私、発情した雌の匂いがする……たまらない……。"
            },
            {
                "text": "モンスターの気配を感じ取り、恐怖ではなく、歓喜で体が震え出した。",
                "dialogue": "来た……♡ 強い魔物さん……。お願い、私のこの張り詰めた体……めちゃくちゃに蹂躙して……！"
            },
            {
                "text": "歩くたびにボヨンボヨンと音を立て、その卑猥な響きをBGMにしている。",
                "dialogue": "聞こえる？ この音……お肉が鳴いてるの。「早く食べて」って……ふふっ、あさましい体……♡"
            },
            {
                "text": "視界の悪い暗闇でも、彼女の発光するような肌と熱気が存在を主張している。",
                "dialogue": "隠れませんよ……。私はここ……。欲望の塊が、ここに落ちてますよぉ……♡"
            },
            {
                "text": "自身の限界サイズを誇りに思い、さらに魔力を求めて彷徨う。",
                "dialogue": "まだ足りない……。もっと大きくなれるはず……。世界中を、私の肉で埋め尽くしたい……。"
            }
        ],

        // ----------------------------------------------------------------
        // Lv1: 一回り小さい (Small ~30cm)
        // 自然物との交わり、サイズ差を利用した快楽
        // ----------------------------------------------------------------
        lv1: [
            {
                "text": "草むらにわざと飛び込み、葉先で全身をくすぐらせている。",
                "dialogue": "ひゃうっ、んくっ♡ ……もっと、もっとワシャワシャしてぇ……！ 自然のブラシで、全身洗ってぇ……！"
            },
            {
                "text": "少し小さくなったことで、突き出た岩などがちょうど良い「玩具」の高さになる。",
                "dialogue": "あ、この岩……形がイイ……♡ ねぇ、ちょっとだけ……擦り付けてもいいよね……？ んぁっ♡"
            },
            {
                "text": "狭い獣道を、巨大な胸で無理やり押し通り、圧迫感を楽しんでいる。",
                "dialogue": "ぎゅうぎゅう……ッ♡ 全身締め付けられて……幸せぇ……。私、このまま詰まっちゃいたい……。"
            },
            {
                "text": "垂れ下がるツタを自分から体に巻き付け、ボンテージのように食い込ませる。",
                "dialogue": "ふふ、似合いますか？ 拘束された、肉感的な妖精……。放置されたら、勝手にイッちゃいますよぉ……？"
            },
            {
                "text": "足元のぬかるみにわざと足を取られ、泥にまみれる感触を味わう。",
                "dialogue": "ヌルッてしたぁ……♡ 泥んこ遊び……。綺麗な肌が汚れちゃう……ふふ、背徳的でゾクゾクするぅ……。"
            },
            {
                "text": "花の蜜の匂いに、自身の甘い体臭を混ぜて、森全体を発情させようとしている。",
                "dialogue": "森の空気ごと、私のフェロモンで犯してあげる……。虫さんも、動物さんも、みんなおかしくなっちゃえ……♡"
            },
            {
                "text": "木漏れ日がスポットライトのように、彼女の膨張した裸体を照らし出す。",
                "dialogue": "眩しい……っ。お日様に見られちゃってる……。興奮して、先端が立ってるの……バレちゃうね……？"
            },
            {
                "text": "小さくなった体で、大きな果実のように木に寄りかかり、誘っている。",
                "dialogue": "もぎたてのフルーツはいかが？ ……中身は、果汁（魔力）たっぷりで……トロトロですよぉ……♡"
            },
            {
                "text": "風に乗って漂う胞子が肌に付着し、その微細な刺激に身悶えする。",
                "dialogue": "んっ……あ……。何かが肌にくっついた……。取らないで……そのまま、私の養分にしてあげる……。"
            },
            {
                "text": "小動物の視線を感じ、見せつけるようにポーズをとる。",
                "dialogue": "リスさん、見てる？ ……ふふ、こんなに大きくてエッチな妖精、初めて見たでしょう……？"
            },
            {
                "text": "自分の体が周囲の植物より鮮やかなピンク色であることを楽しんでいる。",
                "dialogue": "お花より綺麗でしょ？ ……触ったら、花粉じゃなくて……もっとすごい汁が出ちゃうけど……♡"
            },
            {
                "text": "段差を滑り降り、お尻と太ももを地面に擦りつける。",
                "dialogue": "シュルルル……んあぁっ♡ お尻が熱い……！ 摩擦で……火がついちゃいそう……！"
            },
            {
                "text": "川の浅瀬に寝転がり、水流のマッサージを受けている。",
                "dialogue": "お水、気持ちいい……。そこ、重点的に当てて……。あはっ、水流バイブみたい……♡"
            },
            {
                "text": "自分より大きな葉っぱを布団のように被り、その下で秘め事を期待する。",
                "dialogue": "めくったら……大当たりですよ？ ……パンパンに膨らんだご褒美が、待ってます……♡"
            },
            {
                "text": "本能の赴くままに、最も魔力が濃い（危険な）場所へと足を向ける。",
                "dialogue": "濃い魔力……欲しい……。そこに行けば……もっとグチャグチャにしてもらえるんでしょ……？"
            }
        ],
        ...
        lv2: [
            {
                "text": "手頃な大きさの窪みを見つけ、自分からハマりに行き、フィット感を堪能する。",
                "dialogue": "んしょ……すっぽり♡ ここ、私のための場所みたい……。あぁ、全身包まれて……安心するぅ……。"
            },
            {
                "text": "砂利の上を転がりながら、全身のツボ（性感帯）を刺激している。",
                "dialogue": "コロコロ、イくっ、イくっ……♡ あはは！ 転がるだけで絶頂できちゃう……私、便利な玩具だなぁ……♡"
            },
            {
                "text": "水たまりで溺れるフリをして、全身をずぶ濡れにしている。",
                "dialogue": "ぶくぶく……♡ 全身びしょ濡れ……。誰か拾い上げて？ ……濡れたまま、ポケットに入れてもいいよぉ……？"
            },
            {
                "text": "キノコに抱きつき、その弾力と自身の柔らかさを比べて楽しんでいる。",
                "dialogue": "んぎゅーっ♡ ……ふふ、私の勝ち。キノコよりずっと柔らかくて……温かいよぉ……。"
            },
            {
                "text": "小さな虫の行列をまたぐように立ち、下から覗かれる状況に興奮している。",
                "dialogue": "下から丸見えだよ？ ……ふふ、巨大な女体山脈……絶景かな？ 拝んでもいいのよ……？"
            },
            {
                "text": "風に吹かれて木の葉のように舞い、着地の衝撃を快感に変える。",
                "dialogue": "ふわぁ～……ドスンッ♡ ……あひっ、衝撃が子宮に来たぁ……。もっと、高いところから落ちたい……。"
            },
            {
                "text": "自分の体がボールのように弾むことを利用し、ポンポンと跳ねながら進む。",
                "dialogue": "ぽよん、ぽよんっ♪ ……楽しい。私、スーパーボール……。誰か、壁に向かって投げてくれないかなぁ……♡"
            },
            {
                "text": "苔の生えた場所でスライディングし、全身を緑と粘液で汚す。",
                "dialogue": "ズルッ……あはっ♡ 汚くなっちゃった……。悪い妖精さんだ……。お仕置き、必要だよね……？"
            },
            {
                "text": "岩の隙間から漏れる蒸気に当たり、蒸し風呂状態を楽しんでいる。",
                "dialogue": "はぁ……蒸されるぅ……。汗がいっぱい出て……中身も溶け出しそう……。ドロドロ……。"
            },
            {
                "text": "自分の質量を活かして、小さな草花を押し潰しながら「征服」している。",
                "dialogue": "ごめんね、お花さん……。私のお尻の方が重くて……強いの……。んぐぅっ、圧迫感がイイッ♡"
            },
            {
                "text": "モンスターの足跡（巨大な穴）に飛び込み、その大きさに畏怖と劣情を抱く。",
                "dialogue": "すごぉい……大きな足跡……。こんな大きな人に踏まれたら……私、プチッて弾けて……中身ぶち撒けちゃうね……♡"
            },
            {
                "text": "クモの巣にわざと引っかかり、捕食される獲物の気分を味わう。",
                "dialogue": "あ～あ、捕まっちゃった♡ ……蜘蛛さん、早く来て？ 毒を注入して……私を溶かして吸ってぇ……！"
            },
            {
                "text": "自分の体が小さくとも、魔力（性欲）の密度なら誰にも負けないと自負している。",
                "dialogue": "サイズなんて飾りです……。この一粒に詰まった快楽の量……致死量だよぉ……？"
            },
            {
                "text": "水滴が頭に落ちてくるのを、口を開けて待ち構えている。",
                "dialogue": "あーん……♡ んっ、冷たいっ。……ふふ、ダンジョンの体液、飲んじゃった……。"
            },
            {
                "text": "完全に「モノ」になりきり、誰かに拾われるのを待ちながら道端に転がっている。",
                "dialogue": "落とし物ですよぉ……。誰のモノでもない、淫乱な肉便器……拾い食い、しちゃダメですかぁ……？"
            }
        ],
        ...
        lv3: [
            {
                "text": "床のタイルの目地に埋まり、その冷たさと挟まれる感触に恍惚としている。",
                "dialogue": "ハマっちゃったぁ……♡ 抜けない、抜きたくない……。一生ここが私の家……肉の詰め物になりたい……。"
            },
            {
                "text": "埃まみれになりながら、自分がダンジョンのゴミ（塵）になったことに興奮を覚える。",
                "dialogue": "ケホッ、ケホッ……♡ 私はゴミ……ただのピンク色の埃……。掃除機で吸い込むみたいに、扱ってぇ……。"
            },
            {
                "text": "巨大な風圧に吹き飛ばされながら、抵抗せずになされるがままになっている。",
                "dialogue": "きゃあぁぁぁ～ッ♡ どこ行くのぉ～！？ ……どこでもいい、もっと乱暴に扱ってぇ～！！"
            },
            {
                "text": "一粒の砂利に抱きつき、その硬さと自分の柔らかさを擦り合わせている。",
                "dialogue": "石さん、硬い……ゴツゴツしてて素敵……。私のお肉で包んであげる……んちゅ……♡"
            },
            {
                "text": "足元（巨大な床）の振動を全身で感じ、ダンジョン全体とセックスしている気になっている。",
                "dialogue": "地面が震えてる……。あはっ、地球も感じてるの？ 私と一緒……イきまくってるんだね……♡"
            },
            {
                "text": "水たまりの表面張力に捕らわれ、水球の中に閉じ込められる遊びをしている。",
                "dialogue": "んぷっ……！ 水の中……苦しい、でも気持ちいい……。羊水の中にいるみたい……生まれ変わっちゃう……。"
            },
            {
                "text": "通りがかるモンスターの足音を聞き、踏み潰される瞬間を妄想して濡れている。",
                "dialogue": "来る……巨人が来る……。お願い、気づかないで踏んで？ ……グチャッて、私の全てを終わらせて……♡"
            },
            {
                "text": "種子や胞子にまみれ、苗床として利用されることを望んでいる。",
                "dialogue": "んっ……なんか付いた……。種？ ……いいよ、根付いて……。私の魔力吸って、大きく育ってね……♡"
            },
            {
                "text": "極小サイズになったことで、世界そのものが自分を犯しに来ていると感じている。",
                "dialogue": "空気も、光も、音も……全部が私を責めてくる……！ 許容量オーバーだよぉ……あひぃッ♡"
            },
            {
                "text": "小さな穴を見つけると、躊躇なく潜り込み、暗闇の中で蠢く。",
                "dialogue": "暗い穴……大好き……。奥まで入って……誰にも見つからずに、腐るまで喘いでいたい……。"
            },
            {
                "text": "自分の吐息だけで周囲の空気が熱くなるのを感じ、密室のような空間を作る。",
                "dialogue": "はぁ、はぁ……。ここ、私の熱気でムンムン……。淫らなサウナみたい……。"
            },
            {
                "text": "自分が豆粒のような存在であることが、逆に「精液の一滴」のような気分にさせる。",
                "dialogue": "私、白濁したしずく……。世界のどこかに、ポタって落ちて……シミを作ってあげるの……。"
            },
            {
                "text": "何かの幼虫とすれ違い、どちらがより「卑しい肉塊」か張り合おうとする。",
                "dialogue": "うねうね……。貴方も地べたを這ってるの？ ……奇遇だね、私もだよ。どっちが惨めで気持ちいいか、勝負しよ……？"
            },
            {
                "text": "あまりの小ささに、重力の影響が変わり、天井や壁を転がることも厭わない。",
                "dialogue": "壁でも天井でも……どこでも張り付くよ……。私は吸盤……快楽を吸い尽くす寄生虫……♡"
            },
            {
                "text": "完全に自我が崩壊し、ただ「気持ちいい」という信号を発するだけの存在に成り果てた。",
                "dialogue": "あ、あ、う、あ……♡ イイ、イイの……。もう、それしか言えない……あはぁっ♡"
            }
        ]
    }
};
...
const CLICK_EVENT_DIALOGUE_LIBERATION = {
    ...
    // 魔力の予兆を敏感に感じ取り、むしろ待ちわびている
    count_10: { text: ["んっ……来ましたね。魔力の波が……肌を撫でてます。くすぐったい……。", "ふふ、魔力を注いでくれるんですか？ 遠慮しないで……もっと、お願いします♪"], action: "shake" },
    count_20: { text: ["あぁ……熱い……。服がないから、直接体に入ってくる……気持ちいい……。", "そう、そこです……。お腹の奥が熱くなって……体が「変化」を求めてうずいてます……。"], action: "shake_strong" },
    count_30: { text: ["はぁ……っ！ 始まりました……！ 魔力が暴れてる……。さあ、私をどうしたいんですか……？", "ビクッて……全身が跳ねちゃいました。……準備はできてますよ？ 好きな形にして……。"], action: "shake" }, 
    count_40: { text: ["んくぅ……っ♡ 皮膚の下を、電流が走ってるみたい……。これ、クセになっちゃいそう……。", "裸の肌に、魔力が染み込んでいく……。私、あなた色に染められてるみたいで……嬉しい……。"], action: "shake" },
    count_50: { text: ["あぁっ、もう、我慢できないっ……！ 中から突き上げて……膨らみたくて、ウズウズしてるっ……！", "いっぱい……注ぎ込んで……っ！ 私の体、魔力のタンクにしていいですよぉ……ッ！"], action: "shake_strong" },

    // Phase 2: Expansion Lv1
    // 成長を肯定し、喜悦を感じている
    count_60: { text: ["あぁんっ♡ ……ふふ、膨らみました……！ 見て、私の体が……魔力を吸って育っていく……！"], event: "expand_1" },
    count_70: { text: ["パンパンに張ってて……素敵です。指で弾くだけで、飛び上がっちゃいそうなくらい敏感……。", "んっ……。体が熱を持って……生き物みたいに脈打ってる。……もっと、もっと大きくして……？"], action: "shake" },
    count_80: { text: ["まだ足りない……！ まだまだ入ります……！ 私の許容量、甘く見ないでくださいね？", "あはぁ……っ！ 膨らむたびに、快感が脳天を突き抜けるの……！ 止まらないで……！"], action: "shake_strong" },

    // Phase 3: Expansion Lv2
    // 重みを愛し、さらに求める
    count_90: { text: ["んグッ、あぁぁ……ッ♡ ドンッて重くなった……！ これが魔力の質量……たまらない……っ！"], event: "expand_2" },
    count_100: { text: ["たぷん、たぷん……♪ 聞こえますか、この音。お肉がぶつかり合って……拍手してるみたい……。", "重たい……でも、この重さが愛おしいんです。もっと重くして……私を押し潰すくらいに……！"], action: "shake" },
    count_110: { text: ["熱い、熱いよぉ……♡ 全身が性感帯になっちゃった……。風が吹くだけでイッちゃいそう……。", "もう、理性が溶けそうです……。ただの「欲張りな風船」にされちゃう……あはっ、望むところです……！"], action: "shake_strong" },

    // Phase 4: Expansion Lv3
    // 完全に陶酔し、怪物的な変化すら受け入れる
    count_120: { text: ["ひぃンッ♡ ……まんまる……！ 私、魔力のボールになっちゃった……！ 転がして、遊んでぇ……♡"], event: "expand_3" },
    count_130: { text: ["視界が全部ピンク色……。お肉の壁に閉じ込められて……幸せ。ここが私の、新しい世界……。", "ズンッ、ズンッて……子宮に響く振動……。妊娠したみたいに……お腹が熱くて、満たされてる……。"], action: "shake" },
    count_140: { text: ["あひぃッ、裂けちゃう、裂けちゃうよぉ……♡ でも、いいの……壊れるまで膨らませて……ッ！", "限界なんてない……！ 私は魔力の化身……。どこまでも大きく、淫らに育ってあげる……ッ！"], action: "shake_strong" },

    // Phase 5: Limit
    // 絶頂と限界突破
    count_150: { text: ["あﾞあﾞあﾞぁぁぁーーッ♡♡♡ ……完成、しちゃった……。これが、最強の……肉便器ボディ……あはぁ……♡"], event: "expand_4" },

    // 打ち止めループ
    // 完全に理性が飛び、快楽物質だけで思考している
    limit_loop: [
        "はぁ、はぁ……。見て、この浅ましい姿……。顔より大きいおっぱいに埋もれて……私、メスとして完成形です……。",
        "んぅ……っ。ピクピクしてる……。もっと欲しい、もっと詰めて……破裂する寸前が、一番気持ちいいの……。",
        "もう動けません……。一生このまま、魔力の苗床として使ってください……。貴方の好きなように……。",
        "あへぇ……。先端から……魔力が溢れて止まらない……。勿体ないから、吸ってください……ジュルって……。",
        "トクン、トクン……。全身が心臓みたい……。触るだけでイッちゃいそう……あ、イッちゃう、イッちゃうっ♡",
        "重い……熱い……んふっ。この質量全部が、私の快楽……。妖精の誇りなんて、とっくに溶けちゃいましたぁ……。",
        "頭がトロトロです……。何も考えられない……。ただ、揺らされて、喘ぐだけの……幸せな肉袋ですぅ……。",
        "……まだ、刺激するの？ ……もっと、もっといじめて……。私を壊すつもりで、愛してください……ッ♡",
        "あぁ……世界が回るぅ……。私、今、宇宙一気持ちいい……。このまま溶けてなくなりたい……。",
        "んオッ♡ ……中、ドロドロ……。貴方の魔力で、いっぱい満たされて……孕んじゃいそうですぅ……♡"
    ]
};
...
// ▼▼▼ 追加: 解放状態用リセットセリフ (Liberation Ver. - Begging Mode) ▼▼▼
const RESET_DIALOGUE_LIBERATION = {
    // Lv0: 始まった直後に止められた
    lv0: [
        "あれ、もう終わりですか？ ……ふふ、焦らさないで。私の体、もう準備できてますよ？",
        "んっ……。止まっちゃいました。……ねえ、続き。続きをお願いします……♪",
        "ふぅ……。寸止めなんて意地悪です。早く、貴方の魔力で満たしてください……。"
    ],
    // Lv1: 少し膨らんで戻った
    lv1: [
        "あぁん……萎んじゃった。せっかく気持ちよくなってきたところだったのに……。",
        "はぁ……。熱が引いていくのが寂しい……。ねえ、もう一回だけ……大きくしませんか？",
        "戻っちゃいました……。でも、皮膚がまだ覚えてます。……もう一度、パンパンに張らせてほしいな……。"
    ],
    // Lv2: 重みを感じてから戻った
    lv2: [
        "んくぅ……。縮んじゃった。……あのお肉の重み、もう恋しくなってます。",
        "はぁ、はぁ……。夢から覚めた気分です。……お願い、もう一度あの夢を見せてくれませんか？",
        "物足りない……。あんなに満たされてたのに……。お腹の奥が「まだ欲しい」って言ってます……。"
    ],
    // Lv3: 丸い体から戻った
    lv3: [
        "ぷはぁっ……！ ……あぁ、軽くなっちゃった。……なんだか、身軽なのが不安になるくらいです。",
        "……っ。あんなに大きくして、トロトロにさせておいて……。責任取って、もう一回お願いします……♪",
        "すごかったです……。でも、もっと凄くなれたはず……ですよね？ ……ねえ、試してみましょうよぉ……。"
    ],
    // Lv4: 限界突破から戻った
    lv4: [
        "あひぃっ、んあぁっ……♡ ……っ！ 嫌、戻さないで……ッ！ まだ、まだイッてたのにぃ……ッ！",
        "はぁ、はぁ、はぁ……。嘘……私の中身、空っぽ……。ねえ、返して……あの最高の快感を、今すぐ返してよぉ……。",
        "……体が、熱くて疼いて止まりません……。お願いです、もう一度……私を、壊れるくらい大きくしてください……ッ♡"
    ]
};
